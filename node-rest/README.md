...
7. In the **Application Container** tile, click **Action** and select **Open Service Console**.
   ...
   [Description of the illustration: deploy-node-accs-03.jpg](https://raw.githubusercontent.com/emoranchel/JavaTutorials/master/node-rest/img/deploy-node-accs-03.txt)
...
3. On the **Create Application** page, enter `Sample` for the name. Under **Application Artifacts**, click **Choose File** next to **Archive**.
   ...
   [Description of the illustration: deploy-node-accs-04.jpg](https://raw.githubusercontent.com/emoranchel/JavaTutorials/master/node-rest/img/deploy-node-accs-04.txt)
4. In the opened file browser, navigate to the folder where you created `sample.zip`, select the file, and click **Open**.
   ...
   [Description of the illustration: deploy-sample-accs-04.jpg](https://raw.githubusercontent.com/emoranchel/JavaTutorials/master/node-rest/img/deploy-sample-accs-04.txt)
...
2. Copy the application URL.
   ...
   [Description of the illustration: test-sample-accs-07.jpg](https://raw.githubusercontent.com/emoranchel/JavaTutorials/master/node-rest/img/test-sample-accs-07.txt)
